  ...
  return (
    ...
    >
      <div className="section-container flex items-center justify-between">
        <Link 
          to="/" 
          className="text-xl md:text-2xl font-bold flex items-center opacity-90 hover:opacity-100 transition-opacity"
        >
        ...
        {/* Mobile Navigation */}
        {isOpen && (
          <div className="md:hidden fixed inset-0 z-50 bg-white/80 backdrop-blur-xl">
            <div className="flex flex-col h-full pt-24 pb-8 px-6">
              ...
              <button 
                onClick={toggleMenu}
                className="absolute top-6 right-6 text-foreground p-2 rounded-full hover:bg-secondary transition-colors"
